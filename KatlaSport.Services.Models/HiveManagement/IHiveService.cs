...
namespace KatlaSport.Services.HiveManagement
{
    ...
    public interface IHiveService
    {
        ...
        /// </summary>
        /// <param name="hiveId">A hive identifier.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous hive deleting.</returns>
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous setting of a hive status.</returns>
